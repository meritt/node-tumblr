...
(function() {
  ...
  (function() {
    ...
    urlFor = function(action, self, options) {
      ...
      params = ['http://api.tumblr.com/v2/blog/', self.host + '/' + action, (options != null ? options.type : void 0) != null ? '/' + options.type : void 0, '?'];
    ...
    return request = function(url, fn) {
      ...
      return xhr({
        ...
        try {
          ...
          if (body.meta.status !== 200 && body.meta.status !== 301) {
            err = body.meta.msg;
          }
        } catch (_error) {
          error = _error;
